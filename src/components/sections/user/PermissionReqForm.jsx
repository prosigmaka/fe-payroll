...
import {Alert, Box, Container, Collapse, IconButton, Stack, Typography, Grid, TextField, Button} from "@mui/material";
...
function PermissionReqForm() {
    ...
    const handleSubmit = async () => {
        await axios
            .post(
                "http://localhost:8081/v1/api/admin/approval/post",
                dataSubmit,
    ...
    return (
        <Container sx={{ width: '60rem' }} marginTop={5} >
            ...
            <Box
                ...
                marginLeft={5}
                marginRight={5}
                sx={{ minWidth: "50vw", boxShadow: '0 1rem 1rem  rgba(0,0,0,0.2)', backgroundColor: 'rgba(214,249,200,255)' }}>
                <Typography sx={{ flex: '1 1 100%' }} variant="h3" mb={4}>
                    Permission Leave Form
                </Typography>
                <Grid
                    container
                    direction="column"
